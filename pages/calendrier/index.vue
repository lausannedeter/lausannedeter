...
const upcomingEvents = computed(() =>
  useUpcomingEvents(events.value, categoryMap.value, EVENTS_LIMIT).map(normalizeEventDates)
)
...
<template>
  <section class="calendar-page">
    <CalendarFiltersContainer :categories="categories" :activeFilters="activeFilters" @toggle-filters="toggleFilters"
      @toggle-all-filters="toggleAllFilters"></CalendarFiltersContainer>
